...
import production from "@/assets/svgs/logos/authorLogo.svg";
		...
		<>
			...
			<div css={navigate_window_css(globalSettings.naviBarHeight)}>
				<div style={{
					...
					<img src={production} style={{height: 35, marginRight: 5, width: "auto",filter:"drop-shadow(0px 0px 4px rgba(0,0,0,0.15))"}} alt=""/>
					<img src={pure_text_logo} style={{height: 23, width: "auto"}} alt=""/>
				</div>
