...
import home_svg from "@/router/svgComps/home.svg"
import rsa_svg from "@/router/svgComps/rsa.svg"
import mtkit_svg from "@/assets/svgs/logos/Production.svg"
...
export default [
	...
	{
		link: `/${routerPath.mtkit}`,
		title: "乐理计算器Pro",
		subtitle: "一款用于计算乐理的专业程序",
		imgURL: mtkit_svg,
		type: "all"
	},
	{
		link: `/${routerPath.code}`,
		title: "转码工具",
		subtitle: "关于Base64和RSA的工具",
		imgURL: rsa_svg,
		type: "all"
	},
	// {
